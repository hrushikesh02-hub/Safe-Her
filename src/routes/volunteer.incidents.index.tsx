                      ...
                      <div className="flex items-center gap-3">
                        {incident.user?.profileImage ? (
                          <img
                            ...
                            alt={
                              incident.user?.name
                                ? `Profile photo of ${incident.user.name}`
                                : "User profile photo"
                            }
                            className="size-11 rounded-full object-cover"
                          />
                        ) : (
                          <div className="grid size-11 place-items-center rounded-full gradient-hero font-bold text-white">
                            {incident.user?.name?.charAt(0)?.toUpperCase() || "U"}
                          </div>
                        )}
                        <div>
