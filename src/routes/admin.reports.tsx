                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <Button
                            size="sm"
                            variant="outline"
                            onClick={() => downloadEvidenceMedia(inspectData.evidence.videoUrl, `evidence_video_${inspectData.incidentId.slice(-6)}.webm`)}
                      ...
                      <div className="space-y-1.5 pt-1">
                        <div className="flex items-center justify-between">
                          ...
                          <Button
                            size="sm"
                            variant="outline"
                            onClick={() => downloadEvidenceMedia(inspectData.evidence.audioUrl, `evidence_voice_${inspectData.incidentId.slice(-6)}.webm`)}
                            className="h-6 text-[10px] px-2 font-bold"
                          >
